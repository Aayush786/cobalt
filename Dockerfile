...
# FIX: The target directory path must come BEFORE the --prod flag
RUN pnpm deploy /app/prod/api --filter=@imput/cobalt-api --prod
...
# FIX: Instead of copying the entire heavy monorepo workspace,
