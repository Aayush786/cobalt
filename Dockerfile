...
# FIX: Explicitly create the path tree first to stop pnpm's path parsing bug
RUN mkdir -p /app/prod/api && pnpm deploy /app/prod/api --filter=@imput/cobalt-api --prod
